...
\section{\CJKfamily{hei}lambda演算的变换系统}
\begin{frame}
  \frametitle{\CJKfamily{hei}变换系统：简介} 
\end{frame}

\subsection{\CJKfamily{hei}alpha变换}
\subsection{\CJKfamily{hei}beta变换}
\subsection{\CJKfamily{hei}eta变换}

\section{\CJKfamily{hei}简单类型的lambda演算} 
